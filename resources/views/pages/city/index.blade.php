...
@section('content')
    ...
    <div id="Header" class="relative flex items-center justify-between gap-2 px-5 mt-[18px]">
        <div class="flex flex-col gap-[6px]">
            <h1 class="font-bold text-[32px] leading-[48px]">All Cities</h1>
            <p class="text-ngekos-grey">{{ $cities->count() }} Cities Available</p>
        </div>
            ...
            <a href="{{ route('city', ['slug' => $city->slug]) }}" class="card">
                <div
                    ...
                    <div class="flex w-[120px] h-[183px] shrink-0 rounded-[30px] bg-[#D9D9D9] overflow-hidden">
                        <img src="{{ asset('storage/' . $city->image) }}" class="w-full h-full object-cover" alt="icon">
                    </div>
